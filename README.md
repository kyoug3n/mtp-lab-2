...
2²⁰⁰, отказ для `float`, диалог с некорректным вводом и **сверка с `math.gcd` на
...
- неизвестный символ или имя, пропущенное число или операция, лишняя или незакрытая
  скобка;
